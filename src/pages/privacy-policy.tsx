    ...
    <div className="uk-container">
      <main className="uk-margin-top">
        ...
        <p>
          ...
          protects You. It is just copy-pasted fancy looking text that nobody
          reads. Needed for oauth app review.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Scroll-Lock - Tymoteusz Czech
              (http://scroll-lock.pl/).
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to LinkedBot, accessible from
              https://linkedbot.vercel.app/
            </p>
          </li>
          <li>
            <p>
